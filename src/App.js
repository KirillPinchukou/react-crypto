...
function App() {
 ...
 const [search,setSearch]= useState('');
  ...
  useEffect(() => { axios
    .get('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=false" -H "accept: application/json')
    .then(res => {
      setCoins(res.data);
    })
